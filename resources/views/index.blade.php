...
<div class="container d-flex justify-content-center align-items-start" style="height: 70vh;">
  ...
  <fieldset class="bg-primary text-white p-4 rounded w-50">
    <p>Marvel's Heroes Origins est une encyclopédie en ligne consacrée à l'univers Marvel. 
    Son objectif principal est de fournir une source complète d'informations sur les personnages, 
    les lieux (prochainement...) et les événements (prochainement...) qui composent l'univers des bandes dessinées Marvel. Enfin, Marvel'l Heros Origins vise à servir de guide complet et informatif pour les fans de Marvel et les novices, en offrant un accès facile à une mine d'informations sur cet univers fascinant.</p>
  </fieldset>
</div>
